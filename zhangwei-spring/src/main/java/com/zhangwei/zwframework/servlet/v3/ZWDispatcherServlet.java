package com.zhangwei.zwframework.servlet.v3;
 ...
 *
 * @author zhangwei10
 * @create 2019-03-30 2:41 PM
 * @since 1.0.0
 **/
public class ZWDispatcherServlet extends HttpServlet {
    ...
    private void doAutowired(){
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            for (Field field : fields) {
                ...
                if(!field.isAnnotationPresent(ZWAutowired.class)){ continue; }
    ...
    private void initHandlerMapping(){
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            if(!clazz.isAnnotationPresent(ZWController.class)){ continue; }

            String url = "";
            //获取Controller的url配置
            if(clazz.isAnnotationPresent(ZWRequestMapping.class)){
                ZWRequestMapping requestMapping = clazz.getAnnotation(ZWRequestMapping.class);
            ...
            for (Method method : methods) {
                ...
                if(!method.isAnnotationPresent(ZWRequestMapping.class)){ continue; }

                //映射URL
                ZWRequestMapping requestMapping = method.getAnnotation(ZWRequestMapping.class);
